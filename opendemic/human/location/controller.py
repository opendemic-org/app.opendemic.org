...
from opendemic.human.location.types import LocationResourceFields
...
def location():
    ...
    human: Human = model.get_human_from_fingerprint(fingerprint=params[LocationResourceFields.FINGERPRINT.value])
    err: Exception = None
    if human is None:
